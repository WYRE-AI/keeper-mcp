...
export function verifyS2sHeader(
  ...
  // Non-null: HEADER_VALUE_RE has exactly 2 capture groups, so a successful
  // exec() always populates both — this repo's tsconfig sets
  // noUncheckedIndexedAccess, which the other fleet sidecars this file is
  // ported from do not, hence the explicit assertion here.
